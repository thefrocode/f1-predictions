...
To start the development server run `nx serve f1-predictions`. Open your browser and navigate to http://localhost:4200/. Happy coding!
...
npx nx g @nx/angular:library league-players-list --directory libs/leagues/feature/league-players-list
