      ...
      if (this.store.active_race()) {
        ...
        this.config = {
          ...
          prettyText: (text) => {
            ...
            return `<span class="flex flex-row gap-2"><div>
